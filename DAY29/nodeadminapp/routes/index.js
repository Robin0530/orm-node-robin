...
router.post('/login', async(req, res, next)=> {
  ...
  if(member == null) {
    ...
    if (passwordResult) {
      ...
      // 서버 메모리공간에 저장할 로그인한 현재 사용자의 세션정보 구조 및 데이터바인딩
      ...
      // req.session속성에 동적속성으로 loginUser라는 속성을 생성하고 값으로 세션 json값을 세팅한다.
      ...
      // 전달된 쿠키정보를 이용해 서버메모리상의 세션정보를 이용해 로그인한 사용자 정보를 추출한다.
