...
router.get('/detail',async(req,res)=> {
    ...
    // URL에 QueryString방식으로 파라메터가 전달되면 req.query 키명으로 키의값을 추출할 수 있다.
...
router.get('/detail/sendall', async(req, res)=> {
    ...
    // json데이터를 전송해보자
    // res.send({uid:"robin", username:"이보람"});
    ...
    // console.log("__dirname 물리적 경로 확인하기:",__dirname+"102261_174099_3947.jpg");
    res.sendFile(__dirname+"/102261_174099_3947.jpg");
})
...
//호출방식: GET
// 여러개의 파라메터를 여러개의 와일드카드 키명으로로 정의해서 값을 추출해보자
