// 각종 노드 패키지를 참조
// 서버상에서 각종 에러가 발생했을 때 에러 처리를 위한 함수 참조
var createError = require('http-errors');

// node express 웹 개발 프레임워크를 참조
var express = require('express');

// path라는 노드 프레임워크의 파일/폴더 경로정보를 추출하는 패키지를 참조
...
// view engine setup
// MVC 패턴기반 각종 view 파일이 존재한느 물리적 views폴더의 위치를 설정해줍니다.
...
// 개발자 정의 라우팅 미들웨어 
// localhost:3000/user/robin
app.use('/user/:id', function(req,res,next) {
  const uid = req.params.id;
  console.log("어플리ㅔ이션 미들웨어 호출2:", req.method);
  res.send("사용자아이디:"+uid);
})
